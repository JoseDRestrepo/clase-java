									...
									<div class="col-xs-12">
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
                                                                                                    <% for (vehi v:vehiDAO.listarV()) { %>
													<tr>
														<td>
                                                                                                                    <a name="txtvUno" href="#"><%= v.getPlacavehi() %></a>
														</td>
														<td class="hidden-480"><%= v.getMarcavehi() %></td>
                                                                                                                <td><%= v.getRefvehi() %></td>
                                                                                                                
														<td><%= v.getModelovehi() %></td>														
                                                                                                                
                                                                                                                <td>
                                                                                                                    <span class="label label-sm label-success"><%= tipoVehiDAO.getTipoVehi(v.getId_tv()) %></span>
														</td>
														<td>
															...
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<!-- <a class="red" href="#">  -->
                                                                                                                                <a class="red" href="vehiControlador?accion=eliminarUno?placavehi=<%= v.getPlacavehi() %>" name="accion" value="eliminarUno">                                                                                                                                
																	<i class="ace-icon fa fa-trash-o bigger-130"></i>
																</a>
                                                                                                                                <!-- <input type="hidden" name="id" value="<%= v.getPlacavehi() %>">
                                                                                                                                <input type="submit" name="accion" value="eliminarUno"> -->
															</div>
                                                                                                                    <!-- </form> -->
			...
			jQuery(function($) {
				...
				var myTable = $('#dynamic-table').DataTable( {
					...
					order: [],                // sin orden inicial
                        columnDefs: [
                          { orderable: false, targets: [5] } // solo la última (acciones) sin orden
                        ]
			    });
